					...
					<div class="row">
						<div class="col-md-10 col-md-offset-1 to-animate">
							...
							<div class="call-to-action">
								<a href="login.php" class="download">Login Here</a>
							</div>
							<h2>Hey are you a <br> Institute ?</h2>

							<div class="call-to-action">	
								<a href="signup.php" class="download">Sign Up</a>
							</div>
							<div><br>
								<a href="studentlogin.php" class="btn" style="color:red;text-shadow: 0 0 0.2em #87F, 0 0 0.2em #87F,
		       					 0 0 0.2em #87F; font-size:200%">Click Here To Give Exam</a>
							</div>
						</div>
					</div>
				</div>
